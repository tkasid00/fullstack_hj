...
public class Bank_ver3_01level_add {
			...
			if (num1 == 9) {
				...
				if (num1 == 2) {
					...
					if (yn == 'N' || yn == 'n') {
						...
						System.out.println("[BRONZ] : 0~9999원\n출금 수수료 : 10%");
						System.out.println("[SILVER] : 10000~99999원\n출금 수수료 : 7%");
						System.out.println("[GOLD] : 100000~999999원\n출금 수수료 : 5%");
						System.out.println("[VIP] : 1000000원 이상\n출금 수수료 : 3%\n");
