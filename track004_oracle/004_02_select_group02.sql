...
SELECT COMM_EXIST, COUNT(*) AS CNT
FROM(
    SELECT 
        CASE WHEN TO_CHAR(COMM) IS NULL THEN 'X'
             ...
             FROM EMP )
GROUP BY COMM_EXIST
ORDER BY COMM_EXIST DESC;

SELECT NVL2(COMM, 'O', 'X') AS COMM_EXIST, COUNT(*) AS CNT
FROM EMP
GROUP BY NVL2(COMM, 'O', 'X')
ORDER BY COMM_EXIST DESC;

SELECT DECODE(COMM,  NULL, 'X', 'O') AS COMM_EXIST, COUNT(*) AS CNT
FROM EMP
