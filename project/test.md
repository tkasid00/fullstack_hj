4) mvc2
	...
	▶controller
       ...
       [com.pawject.controller]  - ReController
        ...
        [실습] 
            1-1. frontcontroller       web.xml       [com.company.patfooddb.controller] - ReController
            1-2. view 연결
...
++게시판은 리뷰 게시판 형식이 적합해 보임->추후 마이페이지로 빼도 될듯? 개인 기록도 필요하니까. 아니면 내 리뷰 모아보기로 단순 필터링해서 보여줄수도 있고ㅎㅎ
사료에 관한 심도 있는 자료는 게시판 분리가 나을지도?
